...
void cameraInit(void)
{
    ...
    __cameraConfig(EXP_TIME, 450);
    __cameraConfig(FPS, 40);
    ...
    KEY::KEY_Object cam_v("c5");
    cam_v.setOption(v_int);
}
...
void cameraPicOption(void)
{
    if (DMA_ok_flag)
    {
        ...
        screen->displayImage(picReceive.pic, PIC_COL, PIC_LINE);
